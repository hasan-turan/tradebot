...
TICKER = ""
base = " https://cloud.iexapis.com/stable/"  # "https://api.iextrading.com/1.0/"
...
def get_last_price(symbol):
    ...
    # requests.get(base + endpoint, params=payload)
    raw = requests.get(
        'https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=EUR&to_symbol=USD&apikey=BE0O5L3P9EXTSH5D')
    ...
    prices_df["display_time"] = prices_df["time"].dt.strftime(
        "%m-%d-%Y %H:%M:%S.%f")
